...
- [x] Output schema validation — `run.py` validates entity shape, type, and role against allowlists in `schema.py`; malformed Claude responses are skipped and logged
